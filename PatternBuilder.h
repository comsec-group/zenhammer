...
class PatternBuilder {
 private:
  ...
  /// hammering function that is generated at runtime
  JittedFunction fn;
  ...
  void jit_hammering_code(size_t agg_rounds, std::vector<volatile char*>& aggressors, std::vector<volatile char*>& nops);
